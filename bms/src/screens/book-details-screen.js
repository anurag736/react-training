    ...
    return (
        <>
            ...
            <div className="row">
                ...
                <img src={book.cover} className="details-photo"/>
                </div>
                ...
                <div className="col col-8">
                    ...
                    <ul>
                        ...
                        <div className="tags">
                        {book.tags.map((tag,i)=><span className="hmargin5 badge badge-secondary" key={i}>{tag}</span>)}
                        </div>
            ...
            <button className="btn-sm btn-primary" >Add Review</button>
        </>
